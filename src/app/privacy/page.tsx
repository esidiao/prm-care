  ...
  return (
    <div className="min-h-screen bg-card">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-sm text-muted-foreground mb-8">Versão 1.0 — Maio de 2025 — Conforme a LGPD (Lei 13.709/2018)</p>
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">2. Finalidade do Tratamento</h2>
            <ul className="list-disc list-inside space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">3. Base Legal (LGPD)</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">4. Dados de Pacientes</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">7. Compartilhamento de Dados</h2>
