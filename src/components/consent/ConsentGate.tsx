        ...
        <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl overflow-hidden">
          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="space-y-2.5 rounded-xl bg-gray-50 p-4">
              {[
                ...
                <div key={label} className="flex items-start gap-3">
                  <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-brand-800/10">
            ...
            <p className="text-xs text-gray-500">
              ...
              {' · '}
              <a href="/privacy" target="_blank" className="text-brand-800 underline">Política de Privacidade</a>
            </p>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand-800 py-3 text-sm font-semibold text-white hover:bg-brand-900 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              {accepting
