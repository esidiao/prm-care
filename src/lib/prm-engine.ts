...
const KNOWN_INTERACTIONS: KnownInteraction[] = [
  ...
  { drug1: 'varfarina', drug2: 'colestiramina', severity: 'moderate', mechanism: 'Colestiramina liga-se a varfarina no trato gastrointestinal, reduzindo sua absorcao e interrompendo a circulacao entero-hepatica', clinicalEffect: 'Reducao dos niveis de varfarina e do INR — risco de subanticoagulacao e tromboembolismo', management: 'Separar a administracao em pelo menos 4-6 horas (varfarina antes da colestiramina). Monitorar INR.' },
  { drug1: 'dabigatrana', drug2: 'verapamil', severity: 'moderate', mechanism: 'Verapamil inibe a P-glicoproteina, aumentando a absorcao e a exposicao plasmatica da dabigatrana', clinicalEffect: 'Elevacao das concentracoes de dabigatrana e maior risco de sangramento', management: 'Reduzir a dose de dabigatrana e administra-la pelo menos 2 h antes do verapamil. Cautela em insuficiencia renal; monitorar sangramento.' },
  { drug1: 'dabigatrana', drug2: 'amiodarona', severity: 'moderate', mechanism: 'Amiodarona inibe a P-glicoproteina, aumentando a exposicao a dabigatrana', clinicalEffect: 'Aumento das concentracoes de dabigatrana e do risco hemorragico', management: 'Monitorar sinais de sangramento; considerar reducao de dose, sobretudo em insuficiencia renal. Verificar funcao renal.' },
  { drug1: 'escitalopram', drug2: 'naproxeno', severity: 'moderate', mechanism: 'ISRS depleta a serotonina plaquetaria (reduz agregacao) e o AINE inibe a COX-1 plaquetaria e lesa a mucosa gastrica — efeitos hemorragicos aditivos', clinicalEffect: 'Aumento marcado do risco de sangramento gastrointestinal', management: 'Evitar a associacao quando possivel; se necessaria, usar a menor dose/duracao do AINE e associar IBP. Monitorar sinais de sangramento.' },
  { drug1: 'clopidogrel', drug2: 'acido acetilsalicilico', severity: 'moderate', mechanism: 'Inibicao plaquetaria por dois mecanismos complementares: bloqueio do receptor P2Y12 (clopidogrel) e inibicao irreversivel da COX-1/tromboxano (AAS)', clinicalEffect: 'Reducao sinergica da agregacao plaquetaria com aumento do risco de sangramento, sobretudo gastrointestinal', management: 'Dupla antiagregacao tem indicacoes especificas (ex.: pos-SCA/stent) por tempo limitado. Reavaliar duracao e indicacao; associar gastroprotecao com IBP em pacientes de risco.' },
  { drug1: 'enoxaparina', drug2: 'acido acetilsalicilico', severity: 'major', mechanism: 'Anticoagulacao (HBPM, inibicao do fator Xa) somada a inibicao plaquetaria pelo AAS', clinicalEffect: 'Aumento do risco de sangramento por efeitos hemostaticos aditivos', management: 'Avaliar risco-beneficio; associacao tem indicacoes definidas (ex.: SCA). Usar a menor dose eficaz de AAS, monitorar plaquetas/sinais de sangramento e considerar gastroprotecao.' },
  { drug1: 'amiodarona', drug2: 'sotalol', severity: 'contraindicated', mechanism: 'Bloqueio aditivo dos canais de potassio (classe III) com prolongamento sinergico do intervalo QT', clinicalEffect: 'Prolongamento acentuado do QTc com risco elevado de Torsades de Pointes e morte subita', management: 'Combinacao contraindicada. Nao associar dois antiarritmicos classe III. Se troca necessaria, respeitar washout da amiodarona (meia-vida ~40-55 dias) e monitorar ECG/eletrolitos.' },
  { drug1: 'amiodarona', drug2: 'claritromicina', severity: 'major', mechanism: 'Prolongamento aditivo do QT + inibicao da CYP3A4 pela claritromicina elevando niveis de amiodarona', clinicalEffect: 'Torsades de Pointes e arritmia ventricular grave', management: 'Evitar associacao. Preferir azitromicina ou betalactamico. Se inevitavel, ECG (QTc) e correcao de K+/Mg2+.' },
  { drug1: 'ondansetrona', drug2: 'haloperidol', severity: 'major', mechanism: 'Prolongamento aditivo do QT por bloqueio do canal hERG (IKr)', clinicalEffect: 'Prolongamento do QTc com risco de Torsades de Pointes', management: 'Evitar ou minimizar dose de ondansetrona (maximo 16 mg IV). Monitorar ECG e corrigir hipocalemia/hipomagnesemia.' },
  { drug1: 'ondansetrona', drug2: 'metadona', severity: 'major', mechanism: 'Prolongamento aditivo do QT (ambos bloqueiam IKr/hERG)', clinicalEffect: 'Torsades de Pointes, sobretudo com metadona em doses altas', management: 'Evitar associacao. Preferir antiemetico de menor risco. Monitorar ECG (QTc) na metadona e corrigir eletrolitos.' },
  { drug1: 'citalopram', drug2: 'amiodarona', severity: 'major', mechanism: 'Prolongamento aditivo do QT dose-dependente (citalopram) + classe III (amiodarona)', clinicalEffect: 'Prolongamento do QTc com risco de Torsades de Pointes', management: 'Evitar. Respeitar dose maxima de citalopram (40 mg/dia; 20 mg em idosos/CYP2C19 lento). Preferir sertralina. Monitorar ECG.' },
  { drug1: 'escitalopram', drug2: 'amiodarona', severity: 'major', mechanism: 'Prolongamento aditivo do QT dose-dependente (escitalopram) somado ao efeito classe III da amiodarona', clinicalEffect: 'Prolongamento do QTc e risco de arritmia ventricular/Torsades', management: 'Evitar. Limitar escitalopram (max 20 mg/dia; 10 mg em idosos). Preferir sertralina. Monitorar ECG e eletrolitos.' },
  { drug1: 'moxifloxacino', drug2: 'amiodarona', severity: 'contraindicated', mechanism: 'Prolongamento aditivo do QT (moxifloxacino e a fluoroquinolona com maior efeito sobre o QTc) somado ao efeito classe III da amiodarona', clinicalEffect: 'Torsades de Pointes e morte subita', management: 'Evitar combinacao. Preferir betalactamico ou outra classe sem efeito QT. Se inevitavel, ECG (QTc), correcao de K+/Mg2+.' },
  { drug1: 'fluconazol', drug2: 'amiodarona', severity: 'contraindicated', mechanism: 'Prolongamento aditivo do QT (fluconazol bloqueia IKr) + inibicao de CYP3A4 elevando niveis de amiodarona', clinicalEffect: 'Prolongamento do QTc com risco de Torsades de Pointes', management: 'Evitar associacao. Se antifungico imprescindivel, reavaliar opcao e monitorar ECG (QTc) e eletrolitos.' },
  { drug1: 'rifampicina', drug2: 'tacrolimus', severity: 'major', mechanism: 'Rifampicina e indutor potente de CYP3A4 e P-glicoproteina, acelerando o metabolismo e reduzindo a absorcao do tacrolimus', clinicalEffect: 'Queda acentuada dos niveis sericos de tacrolimus, com risco de subimunossupressao e rejeicao do enxerto', management: 'Evitar a associacao quando possivel. Se inevitavel, monitorar nivel serico (C0) de tacrolimus de perto e ajustar a dose para cima, com nova monitorizacao apos suspender a rifampicina.' },
  { drug1: 'rifampicina', drug2: 'ciclosporina', severity: 'major', mechanism: 'Indutor potente de CYP3A4 e P-gp reduz exposicao a ciclosporina', clinicalEffect: 'Reducao marcada dos niveis de ciclosporina e risco de rejeicao de transplante', management: 'Evitar. Se imprescindivel, monitorar ciclosporinemia frequentemente e elevar a dose; reajustar ao suspender a rifampicina.' },
  { drug1: 'claritromicina', drug2: 'tacrolimus', severity: 'major', mechanism: 'Claritromicina inibe potentemente CYP3A4 e P-gp, reduzindo o metabolismo do tacrolimus', clinicalEffect: 'Elevacao dos niveis de tacrolimus com nefrotoxicidade e neurotoxicidade', management: 'Preferir azitromicina. Se usar claritromicina, reduzir a dose de tacrolimus e monitorar nivel serico e funcao renal.' },
  { drug1: 'carbamazepina', drug2: 'varfarina', severity: 'major', mechanism: 'Carbamazepina e indutor de CYP3A4/CYP2C9, aumentando o metabolismo da varfarina', clinicalEffect: 'Reducao do INR e risco de falha anticoagulante (tromboembolismo)', management: 'Monitorar INR ao iniciar/suspender a carbamazepina; em geral e necessario aumentar a dose de varfarina e reajustar depois.' },
  { drug1: 'fenitoina', drug2: 'varfarina', severity: 'major', mechanism: 'Interacao bidirecional: fenitoina induz CYP enzimas (reduzindo varfarina) e pode competir pela CYP2C9 e deslocar a varfarina da ligacao proteica', clinicalEffect: 'Alteracao imprevisivel do INR (flutuacoes), com risco de sangramento ou de trombose', management: 'Monitorar INR e niveis de fenitoina frequentemente; ajustar doses conforme resposta.' },
  { drug1: 'carbamazepina', drug2: 'quetiapina', severity: 'major', mechanism: 'Carbamazepina induz CYP3A4, principal via de metabolizacao da quetiapina', clinicalEffect: 'Reducao acentuada (ate ~80%) dos niveis de quetiapina, com perda do efeito antipsicotico', management: 'Evitar a combinacao; se necessaria, considerar aumento substancial da dose de quetiapina conforme bula e monitorar resposta clinica, reajustando ao suspender a carbamazepina.' },
  { drug1: 'itraconazol', drug2: 'tacrolimus', severity: 'major', mechanism: 'Itraconazol inibe potentemente CYP3A4 e P-gp, reduzindo o metabolismo do tacrolimus', clinicalEffect: 'Aumento dos niveis de tacrolimus com nefrotoxicidade e toxicidade sistemica', management: 'Reduzir empiricamente a dose de tacrolimus ao iniciar itraconazol e monitorar nivel serico e funcao renal intensivamente.' },
  { drug1: 'rifampicina', drug2: 'metadona', severity: 'major', mechanism: 'Rifampicina induz CYP3A4/CYP2B6, acelerando o metabolismo da metadona', clinicalEffect: 'Reducao dos niveis de metadona com sindrome de abstinencia em pacientes dependentes', management: 'Monitorar sinais de abstinencia; pode ser necessario aumentar a dose de metadona durante a rifampicina e reduzir apos a suspensao.' },
  { drug1: 'linezolida', drug2: 'sertralina', severity: 'major', mechanism: 'Linezolida e um inibidor reversivel da MAO; associado a ISRS causa acumulo de serotonina sinaptica', clinicalEffect: 'Sindrome serotoninergica potencialmente fatal (hipertermia, rigidez, clonus, agitacao, instabilidade autonomica)', management: 'Evitar associacao. Se linezolida for imprescindivel, suspender o ISRS e respeitar washout (5 semanas para fluoxetina, 2 semanas para os demais) ou monitorizar em ambiente hospitalar com suspensao imediata do ISRS.' },
  { drug1: 'linezolida', drug2: 'fluoxetina', severity: 'contraindicated', mechanism: 'Inibicao da MAO pela linezolida somada a inibicao da recaptacao de serotonina pela fluoxetina (de meia-vida longa)', clinicalEffect: 'Sindrome serotoninergica grave e crise hipertensiva', management: 'Contraindicado. Fluoxetina exige washout de 5 semanas antes da linezolida devido a meia-vida longa do metabolito ativo.' },
  { drug1: 'linezolida', drug2: 'tramadol', severity: 'major', mechanism: 'Atividade IMAO da linezolida somada a inibicao da recaptacao de serotonina/noradrenalina pelo tramadol', clinicalEffect: 'Sindrome serotoninergica e reducao do limiar convulsivo', management: 'Evitar. Usar analgesico nao serotoninergico durante o tratamento com linezolida.' },
  { drug1: 'linezolida', drug2: 'venlafaxina', severity: 'contraindicated', mechanism: 'Inibicao da MAO pela linezolida combinada a inibicao da recaptacao de serotonina e noradrenalina pela venlafaxina', clinicalEffect: 'Sindrome serotoninergica grave', management: 'Contraindicado. Suspender a venlafaxina e respeitar washout de 7 dias, ou monitorizar em ambiente hospitalar com suspensao imediata.' },
  { drug1: 'inibidor mao', drug2: 'venlafaxina', severity: 'contraindicated', mechanism: 'Inibicao da MAO somada a inibicao da recaptacao de serotonina e noradrenalina (IRSN)', clinicalEffect: 'Sindrome serotoninergica potencialmente fatal e crise hipertensiva', management: 'Contraindicado. Respeitar washout de 14 dias entre IMAO e venlafaxina (e vice-versa).' },
  { drug1: 'inibidor mao', drug2: 'tramadol', severity: 'contraindicated', mechanism: 'Atividade serotoninergica do tramadol potencializada pela inibicao da MAO', clinicalEffect: 'Sindrome serotoninergica e risco convulsivo aumentado', management: 'Contraindicado. Evitar tramadol em uso atual ou recente (14 dias) de IMAO.' },
  { drug1: 'fentanila', drug2: 'fluoxetina', severity: 'major', mechanism: 'Fentanila possui atividade serotoninergica fraca; associada a ISRS pode somar efeitos serotoninergicos', clinicalEffect: 'Sindrome serotoninergica (relatos pos-comercializacao)', management: 'Monitorar sinais de serotoninergismo, sobretudo no inicio ou aumento de dose. Suspender se houver suspeita.' },
  { drug1: 'inibidor mao', drug2: 'sumatriptana', severity: 'contraindicated', mechanism: 'Triptano agonista de receptores 5-HT1 com metabolizacao parcial pela MAO-A; inibicao da MAO eleva a exposicao e o tonus serotoninergico', clinicalEffect: 'Sindrome serotoninergica e aumento da pressao arterial', management: 'Evitar. Sumatriptana e contraindicada em uso de IMAO e ate 2 semanas apos sua suspensao.' },
  { drug1: 'espironolactona', drug2: 'cloreto de potassio', severity: 'major', mechanism: 'Adicao de potassio exogeno a um diuretico poupador de potassio que ja reduz a excrecao renal de K+', clinicalEffect: 'Hipercalemia grave com risco de arritmias e parada cardiaca', management: 'Evitar suplementacao de potassio em usuarios de poupadores de K+, salvo hipocalemia documentada e monitorizacao estreita. Monitorar potassio serico e ECG.' },
  { drug1: 'enalapril', drug2: 'cloreto de potassio', severity: 'major', mechanism: 'IECA reduz a aldosterona e a excrecao renal de potassio; a suplementacao adiciona carga de K+', clinicalEffect: 'Hipercalemia potencialmente fatal (arritmias, fraqueza muscular)', management: 'Evitar suplementos de potassio e substitutos do sal ricos em K+ com IECA. Se indispensavel, monitorar potassio e funcao renal de perto.' },
  { drug1: 'espironolactona', drug2: 'amilorida', severity: 'contraindicated', mechanism: 'Associacao de dois diureticos poupadores de potassio com mecanismos retentores de K+ aditivos', clinicalEffect: 'Hipercalemia grave, sobretudo em insuficiencia renal ou diabetes', management: 'Evitar a combinacao de dois poupadores de potassio. Monitorar potassio serico e funcao renal.' },
  { drug1: 'espironolactona', drug2: 'trimetoprima', severity: 'major', mechanism: 'Trimetoprima bloqueia canais epiteliais de sodio no tubulo distal (efeito amilorida-like), somando-se ao bloqueio da aldosterona', clinicalEffect: 'Hipercalemia grave, com risco aumentado de morte sÃºbita em idosos', management: 'Evitar a associacao em idosos e nefropatas; preferir antibiotico alternativo. Monitorar potassio serico durante o tratamento.' },
  { drug1: 'losartana', drug2: 'trimetoprima', severity: 'major', mechanism: 'BRA reduz a excrecao de potassio (queda de aldosterona) e a trimetoprima bloqueia o canal de sodio epitelial, retendo K+', clinicalEffect: 'Hipercalemia significativa, especialmente em idosos e disfuncao renal', management: 'Evitar cotrimoxazol em usuarios de BRA/IECA idosos; usar antibiotico alternativo. Monitorar potassio e creatinina.' },
  { drug1: 'espironolactona', drug2: 'ibuprofeno', severity: 'major', mechanism: 'AINE inibe prostaglandinas vasodilatadoras renais, reduz fluxo renal e excrecao de potassio, somando-se ao efeito poupador de K+', clinicalEffect: 'Hipercalemia, retencao hidrossalina, reducao do efeito diuretico e nefrotoxicidade (insuficiencia renal aguda)', management: 'Evitar AINEs em usuarios de poupadores de potassio. Preferir paracetamol. Monitorar potassio e funcao renal.' },
  { drug1: 'furosemida', drug2: 'digoxina', severity: 'major', mechanism: 'Diuretico de alca induz hipocalemia e hipomagnesemia, que aumentam a ligacao da digoxina a Na/K-ATPase e a sensibilidade miocardica', clinicalEffect: 'Toxicidade digitalica precipitada pela hipocalemia (arritmias, bloqueio AV)', management: 'Monitorar potassio e magnesio sericos e a digoxinemia; corrigir disturbios eletroliticos. Considerar suplementacao de K+/Mg.' },
  { drug1: 'furosemida', drug2: 'gentamicina', severity: 'major', mechanism: 'Nefrotoxicidade e ototoxicidade aditivas; o diuretico de alca tambem potencializa a lesao coclear e a concentracao tubular do aminoglicosideo', clinicalEffect: 'Insuficiencia renal aguda e ototoxicidade (perda auditiva, vertigem), por vezes irreversiveis', management: 'Evitar a associacao; manter hidratacao, monitorar funcao renal e niveis sericos do aminoglicosideo. Vigiar sinais auditivos/vestibulares.' },
  { drug1: 'pregabalina', drug2: 'oxicodona', severity: 'major', mechanism: 'Depressao aditiva do SNC e do drive respiratorio; gabapentinoide potencializa efeito opioide', clinicalEffect: 'Sedacao profunda, depressao respiratoria e risco aumentado de overdose e obito', management: 'Evitar a associacao. Se imprescindivel, usar a menor dose e menor tempo possiveis, monitorar FR e nivel de sedacao, orientar sinais de alerta e considerar naloxona domiciliar.' },
  { drug1: 'zolpidem', drug2: 'diazepam', severity: 'major', mechanism: 'Depressao aditiva do SNC por dupla acao GABAergica (hipnotico Z + benzodiazepinico)', clinicalEffect: 'Sedacao excessiva, comprometimento psicomotor e risco de quedas/fraturas em idosos', management: 'Evitar uso concomitante de dois sedativos-hipnoticos. Reavaliar necessidade, suspender um dos agentes e orientar prevencao de quedas.' },
  { drug1: 'ciclobenzaprina', drug2: 'tramadol', severity: 'major', mechanism: 'Depressao aditiva do SNC e somatorio do efeito serotoninergico (ambos elevam serotonina)', clinicalEffect: 'Sedacao, risco de sindrome serotoninergica e reducao do limiar convulsivo', management: 'Evitar a combinacao. Se necessario, vigiar sinais de sindrome serotoninergica (agitacao, hipertermia, clonus) e sedacao; preferir relaxante/analgesico alternativo.' },
  { drug1: 'baclofeno', drug2: 'diazepam', severity: 'moderate', mechanism: 'Depressao aditiva do SNC (relaxante muscular de acao central + benzodiazepinico)', clinicalEffect: 'Sedacao excessiva, hipotonia, confusao e quedas, especialmente em idosos', management: 'Evitar associacao quando possivel. Reduzir doses, monitorar sedacao e orientar prevencao de quedas; cautela na retirada para evitar sindrome de abstinencia do baclofeno.' },
  { drug1: 'difenidramina', drug2: 'zolpidem', severity: 'moderate', mechanism: 'Depressao aditiva do SNC e carga anticolinergica somada (anti-histaminico sedativo + hipnotico Z)', clinicalEffect: 'Sedacao prolongada, comprometimento cognitivo, delirium e quedas em idosos', management: 'Evitar dois sedativos com finalidade hipnotica. Suspender o anti-histaminico de 1a geracao; orientar higiene do sono e prevencao de quedas.' },
  { drug1: 'prometazina', drug2: 'codeina', severity: 'major', mechanism: 'Depressao aditiva do SNC e respiratoria (anti-histaminico fenotiazinico sedativo + opioide)', clinicalEffect: 'Sedacao acentuada e depressao respiratoria, com risco grave em criancas e idosos', management: 'Evitar a associacao. Nao usar em menores de 12 anos. Monitorar FR e nivel de sedacao; preferir analgesico/antiemetico alternativo.' },
  { drug1: 'pregabalina', drug2: 'lorazepam', severity: 'moderate', mechanism: 'Depressao aditiva do SNC (gabapentinoide + benzodiazepinico)', clinicalEffect: 'Sedacao excessiva, tontura, ataxia e quedas, sobretudo em idosos e IR', management: 'Evitar ou minimizar doses. Monitorar sedacao e equilibrio, ajustar pregabalina ao ClCr e orientar prevencao de quedas.' },
  { drug1: 'sinvastatina', drug2: 'fenofibrato', severity: 'moderate', mechanism: 'Efeito miotoxico aditivo dos dois agentes hipolipemiantes; o fenofibrato (ao contrario da genfibrozila) nao inibe significativamente a glicuronidacao da estatina, mas a toxicidade muscular se soma.', clinicalEffect: 'Aumento do risco de miopatia e, raramente, rabdomiolise (sobretudo em idosos e na insuficiencia renal).', management: 'Combinacao aceitavel quando indicada (preferivel a genfibrozila): orientar o paciente a relatar dor/fraqueza muscular, monitorar CK basal e na presenca de sintomas, e usar a menor dose eficaz de estatina. Cautela na insuficiencia renal.' },
  { drug1: 'levotiroxina', drug2: 'varfarina', severity: 'moderate', mechanism: 'Hormonio tireoidiano aumenta o catabolismo dos fatores de coagulacao dependentes da vitamina K, potencializando o efeito anticoagulante; o inicio ou ajuste da reposicao de levotiroxina altera a resposta a varfarina.', clinicalEffect: 'Aumento do INR e risco de sangramento ao iniciar/aumentar a levotiroxina (e queda do INR se a dose tireoidiana for reduzida).', management: 'Monitorar INR com mais frequencia ao iniciar, ajustar ou suspender a levotiroxina, ajustando a dose de varfarina conforme necessario ate estabilizar o estado tireoidiano.' },
  { drug1: 'levotiroxina', drug2: 'colestiramina', severity: 'moderate', mechanism: 'A colestiramina (resina sequestrante de acidos biliares) liga-se a levotiroxina no trato gastrointestinal, reduzindo sua absorcao.', clinicalEffect: 'Reducao da eficacia da reposicao tireoidiana, com elevacao do TSH e retorno de sintomas de hipotireoidismo.', management: 'Administrar a levotiroxina ao menos 4 horas antes ou apos a colestiramina e monitorar o TSH.' },
  { drug1: 'levotiroxina', drug2: 'omeprazol', severity: 'moderate', mechanism: 'A elevacao do pH gastrico pelos inibidores da bomba de protons reduz a dissolucao e a absorcao da levotiroxina.', clinicalEffect: 'Reducao da absorcao da levotiroxina, com possivel elevacao do TSH e necessidade de ajuste de dose.', management: 'Monitorar o TSH apos iniciar/suspender o omeprazol e reajustar a dose de levotiroxina se necessario; considerar formulacoes liquidas/em gel quando disponiveis.' },
  { drug1: 'glibenclamida', drug2: 'sulfametoxazol', severity: 'moderate', mechanism: 'As sulfonamidas inibem o metabolismo (CYP2C9) e deslocam a sulfonilureia das proteinas plasmaticas, alem de efeito hipoglicemiante intrinseco aditivo.', clinicalEffect: 'Hipoglicemia grave e prolongada, especialmente em idosos e na insuficiencia renal.', management: 'Monitorar a glicemia de perto durante a antibioticoterapia; orientar reconhecimento de hipoglicemia e considerar reducao da dose da sulfonilureia ou antibiotico alternativo.' },
  { drug1: 'prednisona', drug2: 'glibenclamida', severity: 'moderate', mechanism: 'Os corticosteroides induzem resistencia insulinica, gliconeogenese e glicogenolise, antagonizando o efeito hipoglicemiante das sulfonilureias.', clinicalEffect: 'Perda do controle glicemico com hiperglicemia (e risco de hipoglicemia na retirada abrupta do corticoide).', management: 'Intensificar a monitorizacao da glicemia ao iniciar, ajustar ou suspender o corticoide; ajustar a dose do antidiabetico (frequentemente necessario intensificar) e reduzir gradualmente o corticoide.' },
  { drug1: 'propranolol', drug2: 'glibenclamida', severity: 'moderate', mechanism: 'Betabloqueadores nao seletivos mascaram os sinais adrenergicos de alerta da hipoglicemia (tremor, taquicardia, palpitacoes) e podem prolongar/intensificar a hipoglicemia ao inibir a glicogenolise mediada por beta-2.', clinicalEffect: 'Hipoglicemia nao percebida e prolongada (a sudorese pode persistir); possivel hipertensao reflexa durante a hipoglicemia.', management: 'Preferir betabloqueador cardiosseletivo (metoprolol, bisoprolol) em diabeticos; orientar o paciente que a sudorese pode ser o unico sinal e monitorar a glicemia.' },
  { drug1: 'rosuvastatina', drug2: 'ciclosporina', severity: 'major', mechanism: 'A ciclosporina inibe os transportadores OATP1B1 e BCRP, reduzindo drasticamente o clearance hepatico da rosuvastatina e elevando sua exposicao sistemica em ate ~7 vezes.', clinicalEffect: 'Aumento acentuado dos niveis de rosuvastatina com risco de miopatia e rabdomiolise.', management: 'Limitar a rosuvastatina a 5 mg/dia em pacientes em uso de ciclosporina; monitorar CK e sintomas musculares (ou considerar estatina alternativa).' },
  { drug1: 'alopurinol', drug2: 'mercaptopurina', severity: 'major', mechanism: 'Alopurinol inibe a xantina oxidase, enzima responsavel pela inativacao da 6-mercaptopurina, elevando suas concentracoes plasmaticas ativas', clinicalEffect: 'Mielossupressao grave: leucopenia, trombocitopenia e pancitopenia potencialmente fatal', management: 'Reduzir a dose de mercaptopurina para 25-33% da habitual se a combinacao for inevitavel. Monitorar hemograma de perto. Preferir evitar.' },
  { drug1: 'capecitabina', drug2: 'varfarina', severity: 'major', mechanism: 'Capecitabina (pro-farmaco do 5-fluorouracil) inibe a CYP2C9, reduzindo o metabolismo da varfarina', clinicalEffect: 'Elevacao do INR e sangramento grave, podendo ocorrer dias a semanas apos o inicio', management: 'Monitorar INR com frequencia (alerta de caixa-preta do FDA). Ajustar dose de varfarina. Considerar anticoagulante alternativo.' },
  { drug1: 'capecitabina', drug2: 'fenitoina', severity: 'major', mechanism: 'Capecitabina inibe a CYP2C9, reduzindo o metabolismo da fenitoina', clinicalEffect: 'Toxicidade por fenitoina: nistagmo, ataxia, sedacao, confusao', management: 'Monitorar nivel serico de fenitoina e ajustar a dose. Vigiar sinais de toxicidade.' },
  { drug1: 'ciclosporina', drug2: 'sinvastatina', severity: 'contraindicated', mechanism: 'Ciclosporina inibe CYP3A4, OATP1B1 e P-gp, elevando muito a exposicao a sinvastatina', clinicalEffect: 'Miopatia e rabdomiolise com risco de insuficiencia renal aguda', management: 'Contraindicado o uso concomitante com sinvastatina. Preferir pravastatina/fluvastatina em dose baixa ou ezetimiba; monitorar CPK e sintomas musculares.' },
  { drug1: 'metotrexato', drug2: 'omeprazol', severity: 'major', mechanism: 'IBP inibe a secrecao tubular renal do metotrexato (transportador BCRP/OAT3), reduzindo sua eliminacao, sobretudo em altas doses', clinicalEffect: 'Elevacao e atraso na depuracao do metotrexato: mielossupressao, mucosite e nefrotoxicidade', management: 'Em metotrexato de alta dose, suspender o IBP e preferir bloqueador H2 (ex.: ranitidina). Monitorar niveis de metotrexato e funcao renal.' },
  { drug1: 'metotrexato', drug2: 'probenecida', severity: 'major', mechanism: 'Probenecida inibe a secrecao tubular renal do metotrexato, reduzindo seu clearance', clinicalEffect: 'Aumento das concentracoes de metotrexato com toxicidade: pancitopenia, mucosite, nefrotoxicidade', management: 'Evitar a associacao. Se inevitavel, reduzir dose de metotrexato e monitorar niveis sericos, hemograma e funcao renal.' },
  // ANTICOAGULANTES
  ...
  { drug1: 'varfarina', drug2: 'claritromicina', severity: 'major', mechanism: 'Inibição de CYP3A4/CYP2C9 reduz o metabolismo da varfarina', clinicalEffect: 'Aumento do INR e risco de sangramento', management: 'Preferir azitromicina; se inevitável, monitorar INR de perto.' },
  { drug1: 'varfarina', drug2: 'fluconazol', severity: 'major', mechanism: 'Fluconazol inibe potentemente a CYP2C9', clinicalEffect: 'Elevação acentuada do INR — hemorragia', management: 'Evitar ou reduzir varfarina; monitorar INR frequentemente.' },
  { drug1: 'varfarina', drug2: 'amiodarona', severity: 'major', mechanism: 'Amiodarona inibe CYP2C9/CYP3A4 (efeito prolongado por meia-vida longa)', clinicalEffect: 'Aumento do INR por semanas — sangramento', management: 'Reduzir varfarina ~30-50% ao iniciar amiodarona; monitorar INR por semanas.' },
  { drug1: 'varfarina', drug2: 'metronidazol', severity: 'major', mechanism: 'Inibição do metabolismo da varfarina (CYP2C9)', clinicalEffect: 'Aumento do INR e risco de sangramento', management: 'Monitorar INR; considerar redução temporária da varfarina.' },
  { drug1: 'amiodarona', drug2: 'digoxina', severity: 'major', mechanism: 'Amiodarona inibe a P-glicoproteína, elevando a digoxinemia', clinicalEffect: 'Toxicidade digitálica (bradicardia, arritmias, náusea, distúrbios visuais)', management: 'Reduzir a dose de digoxina ~50%; monitorar digoxinemia e ECG.' },
  { drug1: 'amiodarona', drug2: 'sinvastatina', severity: 'major', mechanism: 'Amiodarona inibe a CYP3A4, elevando a sinvastatina', clinicalEffect: 'Miopatia/rabdomiólise', management: 'Limitar sinvastatina a 20 mg/dia com amiodarona ou usar estatina alternativa (pravastatina/rosuvastatina).' },
...
const CLASS_INTERACTIONS: ClassInteraction[] = [
  ...
  { class1: 'ISRS', class2: 'AINE', severity: 'moderate', mechanism: 'ISRS reduzem a captação plaquetária de serotonina (↓agregação) e somam-se à lesão de mucosa pelo AINE', clinicalEffect: 'Aumento do risco de sangramento gastrointestinal', management: 'Cautela; associar gastroproteção (IBP) e reavaliar necessidade do AINE, sobretudo em idosos.' },
]
...
/**
 * Política de duplicidade por classe.
 *
 * Nem toda classe repetida é duplicidade: em várias, a associação é o padrão de
 * cuidado, e alertar sobre ela produz fadiga de alerta em cima de conduta
 * CORRETA — o farmacêutico deixa de confiar no módulo.
 *
 * `exempt`  → a associação é conduta padrão; nunca gerar achado.
 * `risk`    → gravidade calibrada pelo dano da repetição, não uniforme.
 * `caveat`  → há cenário legítimo; entra no texto para o farmacêutico julgar.
 */
interface DuplicationPolicy {
  exempt?: true
  exemptReason?: string
  risk?: RiskLevel
  caveat?: string
...
const DUPLICATION_POLICY: Record<string, DuplicationPolicy> = {
  // ── Associação é padrão de cuidado — não alertar ──────────────────────────
  'Antiagregante': {
    exempt: true,
    exemptReason: 'dupla antiagregação (AAS + inibidor de P2Y12) é conduta padrão após SCA/stent',
  },
  'Opioide': {
    exempt: true,
    exemptReason: 'opioide basal de longa duração + resgate de curta é o esquema padrão em dor crônica/oncológica',
  },
  'Nitrato': {
    exempt: true,
    exemptReason: 'nitrato de longa duração + sublingual de resgate é o esquema padrão em angina',
  },
  // Subconjunto de 'Bloqueador Ca' (verapamil/diltiazem). Sem isenção aqui, um
  // paciente com os dois gera DOIS achados para o mesmo problema.
  'BCC não-diidropiridínico': {
    exempt: true,
    exemptReason: 'subconjunto de Bloqueador Ca — a duplicidade já é reportada por aquela classe',
  },

  // ── Duplicidade de alto risco ─────────────────────────────────────────────
  'Anticoagulante oral': { risk: RiskLevel.URGENT },
  'AINE':                { risk: RiskLevel.HIGH },
  'Benzodiazepínico':    { risk: RiskLevel.HIGH },
  'Hipnótico Z':         { risk: RiskLevel.HIGH },
  'ISRS':                { risk: RiskLevel.HIGH },
  'Antidepressivo tricíclico': { risk: RiskLevel.HIGH },
  'Sulfonilureia':       { risk: RiskLevel.HIGH },
  'IECA':                { risk: RiskLevel.HIGH },
  'BRA-II (Sartana)':    { risk: RiskLevel.HIGH },

  // ── Duplicidade com cenário legítimo possível ─────────────────────────────
  'Antipsicótico': {
    risk: RiskLevel.MODERATE,
    caveat: 'A associação de antipsicóticos pode ser intencional em psiquiatria refratária, mas é desencorajada como rotina.',
  },
  'Antihistamínico H1': {
    risk: RiskLevel.MODERATE,
    caveat: 'Pode ser intencional (não-sedativo de dia + sedativo à noite); confirmar a intenção.',
  },
  'Diurético de alça': {
    risk: RiskLevel.MODERATE,
    caveat: 'Bloqueio sequencial do néfron pode ser intencional em ICC refratária — mas com alça + tiazídico, não dois de alça.',
  },
}

/** Sem política explícita, a duplicidade é moderada. */
const DUPLICATION_DEFAULT_RISK = RiskLevel.MODERATE

function checkDuplicateTherapy(medications: MedicationContext[]) {
  const duplicates: Array<{ group: MedicationContext[]; reason: string; className: string; risk: RiskLevel; caveat?: string }> = []
  for (const [className, keywords] of Object.entries(CLASS_KEYWORDS)) {
    const policy = DUPLICATION_POLICY[className] || {}
    ...
    // Dois REGISTROS do mesmo princípio ativo continuam sendo duplicidade real
    // (bula + genérico, ou lançamento repetido) — não deduplicar por nome.
    if (matching.length > 1) {
      duplicates.push({
        group: matching,
        className,
        risk: policy.risk || DUPLICATION_DEFAULT_RISK,
...
function findNecessityPRMs(context: PatientContext): PRMFindingResult[] {
  ...
  for (const dup of checkDuplicateTherapy(context.medications)) {
    findings.push({
      category: PRMCategory.NECESSITY,
      riskLevel: dup.risk,
      title: `Duplicidade terapêutica — ${dup.className}`,
      description: dup.caveat ? `${dup.reason} ${dup.caveat}` : dup.reason,
...
const SUPPLEMENT_INTERACTIONS: FoodDrugInteraction[] = [
  ...
  { food: 'Cranberry (oxicoco)', emoji: '🫐', drugs: ['varfarina'], severity: 'moderate', mechanism: 'Possível inibição do metabolismo da varfarina (CYP2C9)', clinicalEffect: 'Aumento do INR e risco de sangramento', management: 'Monitorar INR se consumo regular de cranberry; orientar consistência.', patientGuidance: 'Suco/cápsulas de cranberry em excesso podem aumentar o efeito da varfarina.' },
  { food: 'Coenzima Q10 (ubiquinona)', emoji: '💊', drugs: ['varfarina'], severity: 'moderate', mechanism: 'Estrutura semelhante à vitamina K — efeito pró-coagulante', clinicalEffect: 'Redução do INR e da anticoagulação', management: 'Monitorar INR ao iniciar/suspender CoQ10.', patientGuidance: 'CoQ10 pode reduzir o efeito da varfarina — avise a equipe.' },
  { food: 'Cúrcuma / açafrão-da-terra (curcumina, altas doses)', emoji: '🟡', drugs: ['varfarina', 'acido acetilsalicilico', 'clopidogrel', 'rivaroxabana', 'apixabana'], severity: 'moderate', mechanism: 'Efeito antiplaquetário/antitrombótico em altas doses', clinicalEffect: 'Aumento do risco de sangramento', management: 'Cautela com suplementos concentrados de cúrcuma em anticoagulados.', patientGuidance: 'Suplemento concentrado de cúrcuma pode aumentar sangramento com anticoagulante.' },
  { food: 'Gengibre (suplemento, altas doses)', emoji: '🫚', drugs: ['varfarina', 'acido acetilsalicilico', 'clopidogrel', 'rivaroxabana', 'apixabana'], severity: 'moderate', mechanism: 'Inibição da agregação plaquetária', clinicalEffect: 'Aumento do risco de sangramento', management: 'Cautela em doses altas com anticoagulantes/antiagregantes.', patientGuidance: 'Gengibre em cápsulas/altas doses pode somar ao anticoagulante.' },
  { food: 'Saw palmetto', emoji: '🌴', drugs: ['varfarina', 'acido acetilsalicilico', 'clopidogrel'], severity: 'moderate', mechanism: 'Possível efeito antiplaquetário', clinicalEffect: 'Aumento do risco de sangramento', management: 'Cautela em anticoagulados/antiagregados.', patientGuidance: 'Saw palmetto pode aumentar risco de sangramento — avise a equipe.' },
  { food: 'Melatonina', emoji: '😴', drugs: ['diazepam', 'alprazolam', 'clonazepam', 'lorazepam', 'zolpidem', 'zopiclona', 'varfarina'], severity: 'moderate', mechanism: 'Sedação aditiva; possível efeito sobre INR', clinicalEffect: 'Sonolência excessiva; variação do INR com varfarina', management: 'Cautela com sedativos; monitorar INR se varfarina.', patientGuidance: 'Melatonina com calmantes aumenta a sonolência; avise se usa varfarina.' },
  { food: 'Magnésio / antiácidos (suplemento)', emoji: '💊', drugs: ['ciprofloxacino', 'levofloxacino', 'levotiroxina', 'alendronato'], severity: 'moderate', mechanism: 'Quelação por cátions di/trivalentes — reduz a absorção', clinicalEffect: 'Falha terapêutica por má absorção do fármaco', management: 'Separar a administração por ≥2–4 h.', patientGuidance: 'Tome magnésio/antiácido longe do antibiótico, da levotiroxina ou do bifosfonato.' },
  { food: 'Ferro (suplemento)', emoji: '💊', drugs: ['levotiroxina', 'ciprofloxacino', 'levofloxacino', 'alendronato'], severity: 'moderate', mechanism: 'Quelação — reduz a absorção do fármaco', clinicalEffect: 'Redução da eficácia (levotiroxina/antibiótico/bifosfonato)', management: 'Separar a administração por ≥4 h.', patientGuidance: 'Tome o ferro com várias horas de diferença da levotiroxina/antibiótico.' },
  { food: 'L-triptofano / 5-HTP', emoji: '🌿', drugs: ['fluoxetina', 'sertralina', 'paroxetina', 'citalopram', 'escitalopram', 'venlafaxina', 'duloxetina', 'tramadol'], severity: 'major', mechanism: 'Aumento da disponibilidade de serotonina (aditivo)', clinicalEffect: 'Risco de síndrome serotoninérgica', management: 'Evitar com antidepressivos serotoninérgicos/tramadol.', patientGuidance: 'Não use L-triptofano/5-HTP com antidepressivos — risco de reação grave.' },
  { food: 'Efedra (Ma huang) / sinefrina', emoji: '⚠️', drugs: ['fenelzina', 'tranilcipromina', 'selegilina', 'enalapril', 'losartana', 'atenolol', 'metoprolol'], severity: 'major', mechanism: 'Estimulação simpática; potencializada por IMAO; antagoniza anti-hipertensivos', clinicalEffect: 'Crise hipertensiva, taquiarritmias', management: 'Evitar termogênicos com efedra/sinefrina, sobretudo com IMAO/anti-hipertensivos.', patientGuidance: 'Evite suplementos "termogênicos" com efedra/sinefrina — podem elevar muito a pressão.' },
  { food: 'Chá-verde (extrato concentrado)', emoji: '🍵', drugs: ['varfarina'], severity: 'moderate', mechanism: 'Contém vitamina K — efeito antagonista', clinicalEffect: 'Redução do INR', management: 'Manter consumo estável; cautela com extratos concentrados.', patientGuidance: 'Extrato de chá-verde em cápsula pode reduzir o efeito da varfarina.' },
  { food: 'Vitamina B6 (piridoxina, altas doses)', emoji: '💊', drugs: ['levodopa'], severity: 'moderate', mechanism: 'Acelera a descarboxilação periférica da levodopa', clinicalEffect: 'Redução do efeito antiparkinsoniano (quando levodopa sem carbidopa)', management: 'Atenção a altas doses de B6 com levodopa.', patientGuidance: 'Altas doses de vitamina B6 podem reduzir o efeito do remédio de Parkinson.' },
  { food: 'Alcaçuz (licorice)', emoji: '🍬', drugs: ['hidroclorotiazida', 'furosemida', 'clortalidona', 'digoxina', 'enalapril', 'losartana'], severity: 'moderate', mechanism: 'Efeito mineralocorticoide → retenção de sódio e perda de potássio', clinicalEffect: 'Hipocalemia (potencializa toxicidade da digoxina), hipertensão e antagonismo de anti-hipertensivos', management: 'Evitar consumo regular de alcaçuz; monitorar K⁺ e PA.', patientGuidance: 'Alcaçuz em excesso baixa o potássio e sobe a pressão — evite se usa diurético/digoxina.' },
]
